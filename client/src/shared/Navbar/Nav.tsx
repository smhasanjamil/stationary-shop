import { NavDropdown } from "@/shared/Navbar/NavDropdown";
                  ...
                  <li key={idx} >
                    {item.isDrapdown ? (
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          isActive
                            ? "block text-gray-800 hover:text-gray-600 font-bold"
                            : "block text-gray-700 hover:text-gray-600"
                        }
                      >
                        {item.title}
                      </NavLink>
                    ...
                    drapdownState.isActive ? (
                      <div className="md:z-30 bg-white md:container md:mx-auto mt-6 inset-x-0 top-20 w-full md:absolute md:border-y md:shadow-md md:mt-0">
                              ...
                              <ul className="mt-5 space-y-6">
                                {dropdownItem.navs.map((navItem, idx) => (
                                  <li key={idx} className="group">
                                    ...
                                    >
                                      <div className="w-12 h-12 rounded-full bg-gray-50 text-gray-600 flex items-center justify-center duration-150 group-hover:bg-gray-600 group-hover:text-white md:w-14 md:h-14">
                                        {navItem.icon}
                                      </div>
                                      <div>
                                        <span className="text-gray-800 duration-200 group-hover:text-gray-600 text-sm font-medium md:text-base">
                                          {navItem.title}
                                        </span>
              ...
              {isLoggedIn ? (
                ...
                <div className="flex-1 items-center justify-end gap-x-6 space-y-3  md:flex md:space-y-0">
                  <li>
                    <Link
                      to="/login"
                      className="block py-3 text-center text-gray-700 hover:text-gray-600 border rounded-lg md:border-none"
                    >
                      Log in
                    </Link>
                  </li>
                  <li>
                    <Link
                      to="/signup"
                      className="block py-3 px-4 font-medium text-center text-white bg-gray-600 hover:bg-gray-500 active:bg-gray-700 active:shadow-none rounded-lg shadow md:inline"
                    >
                      Sign up
                    </Link>
                  </li>
